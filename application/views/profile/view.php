<body>
    ...
    <div>
        <div class="tombol-tambah">
            <a href='<?= site_url('profile/create'); ?>'><img src="<?php echo base_url() ?>/media/images/add.png "></a>
        </div>
        <div id="table">
                ...
                if (!empty($data)) {
                    ...
                    foreach ($data as $row) {
                        ...
                        <tr class="isi">
                            ...
                            <td id="action" style="width: 140px;"> <a href="<?= site_url('profile/update/' . $row->id); ?>"><button type="button" class="btn btn-primary" style="padding: 2px 5px;">update</button> | <a href="<?php echo site_url('profile/delete/' . $row->id); ?>" onclick="return confirm('Apakah Anda Yakin?');"><button type="button" class="btn btn-danger" style="padding: 2px 5px;">delete</button></td>
                        </tr>
                        <?php
                        $no++;
                    }
