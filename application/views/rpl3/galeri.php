                ...
                if (!empty($data)) {
                    ...
                    foreach ($data as $row) {
                        ...
                        <tr class="isi">
                            ...
                            <td id="foto" style="width: 140px;"><img class="img-rounded" src="<?php echo base_url() ?>/uploads_3/<?php echo $row->foto; ?>.jpg" width="130px" height="auto" style="border-style: solid;border-width: 4px;border-color: black; padding: 5px;"/></td>
                        </tr>
                        <?php
                        $no++;
                    }
